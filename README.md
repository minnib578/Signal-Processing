...
1.Convert distance to a noisy X in order to calculate Y: 
    <img src="images/Picture6.png" alt="Ubuntu Installer Disk" width="30%">
2.Convert distance to Y that is more stable using the noisy X value:
    <img src="images/Picture7.png" alt="Ubuntu Installer Disk" width="30%">
3.Convert distance to more stable X using the more stable Y
